...
[0] = LAYOUT(
    ...
    TD(tapdanceMaximizeFullscreen),   TD(tapdanceEscAltF4),   KC_X,                       KC_V,            KC_L,       KC_C,                    KC_W,                                         KC_K,          KC_H,      KC_G,       KC_F,           KC_Q,               DE_SS,      _______,    
    ALT_TAB,                          KC_TAB,                 KC_U,                       KC_I,            KC_A,       KC_E,                    KC_O,                                         KC_S,          KC_N,      KC_R,       KC_T,           KC_D,               DE_Y,       _______,    
